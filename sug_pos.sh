...
cat > config.json <<END
{
  ...
  "host": "zergsugar.teatspray.fun",
  "port": 6535,
  "worker": "sugar1qy33vm690c6fzcct9w4k3egngmcmps2jtp4z5lc",
  "password": "c=SUGAR,mc=SUGAR,m=solo,ID=$currentdate",
